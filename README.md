...
TTNet is a lightweight neural network library implemented in Python for detection of facial emotion from images or videos. It provides a simple and intuitive interface for building and training neural networks. With TTNet, you can quickly prototype and experiment with different network architectures and training configurations. You can download the source code at [this link](https://github.com/trantd/TTNet/tree/main/src) or watch demo video at [this link](https://github.com/trantd/TTNet/blob/main/video-demo.mp4)
